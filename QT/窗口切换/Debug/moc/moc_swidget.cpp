...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SWidget_t qt_meta_stringdata_SWidget = {
    {
QT_MOC_LITERAL(0, 0, 7), // "SWidget"
...
void SWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SWidget::back)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SWidget.data,
    qt_meta_data_SWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SWidget.stringdata0))
